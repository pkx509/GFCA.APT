...
let sizePopup = new (function () {

    let _args = null;

    //UI
    this.popup_id      = "#popup-size";
    ...
    this.OnDataBound = function () {
        //var gridObj = document.getElementById('grdSize')['ej2_instances'][0];
        //Object.assign(gridObj.filterModule.filterOperators, { startsWith: 'contains' });
    }
    this.OnToolbarClick = function (args) {

        let gridObj = document.getElementById("grdSize").ej2_instances[0];
