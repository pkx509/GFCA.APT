...
let costcenterPopup = new (function () {

    let self = null;
    let _args = null;

    //UI
    this.popup_id = "#popup-costcenter";
    ...
    this.OnExcelExportClick = function (args) {
        let gridObj = document.getElementById("grdCostcenter").ej2_instances[0];
        if (args.item.id === 'grdCostcenter_excelexport') {
            gridObj.excelExport();
        }
    }
