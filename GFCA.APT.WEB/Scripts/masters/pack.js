...
$(document).ready(function () {
    let sendPost = function (url, data) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (res.Success === true) {
                    packPopup.close();
                    let objGrid = document.getElementById("grdPack").ej2_instances[0];
                    if (objGrid) {
                        objGrid.refresh();
                    } else {
    ...
    $("#toolbar_add").click(function (e) {
        ...
        packPopup.open(POPUP_MODE.CREATE, argruments.data, callBack);
    ...
    $("#toolbar_edit").click(function (e) {
        ...
        packPopup.open(POPUP_MODE.EDIT, argruments.data, callBack);
    });
    $("#toolbar_del").click(function (e) {
        ...
        packPopup.open(POPUP_MODE.DELETE, argruments.data, callBack);
    });
