...
$(document).ready(function () {
    ...
    $("#toolbar_add").click(function (e) {
        ...
        gl_accountPopup.open(POPUP_MODE.CREATE, argruments.data, callBack);
    ...
    $("#toolbar_edit").click(function (e) {
        ...
        gl_accountPopup.open(POPUP_MODE.EDIT, argruments.data, callBack);
    });
    $("#toolbar_del").click(function (e) {
        ...
        gl_accountPopup.open(POPUP_MODE.DELETE, argruments.data, callBack);
    });
