...
let fixedContractHeaderPopup = new (function () {

    let self = null;
    let _args = null;

    //UI
    this.popup_id = "#popup-fixedContractHeader";
    ...
    this.open = function (popupMode, dataSelection, fn) {
        if (popupMode === POPUP_MODE.CREATE) {
            this.init();
            this.callBack = fn;
            this.setHeading("Create New Fixed Contract");
    ...
    */
    ...
    this.OnExcelExportClick = function (args) {
        ...
        if (args.item.id === 'grdFixedContract_excelexport') {
            gridObj.excelExport();
        }
    }
})();