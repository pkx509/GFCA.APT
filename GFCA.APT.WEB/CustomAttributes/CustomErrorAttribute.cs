...
{
    public class CustomErrorAttribute : HandleErrorAttribute, IExceptionFilter, IActionFilter
    {
        ...
        public override void OnException(ExceptionContext filterContext)
        {
            ...
            */
            var loggingWatch = filterContext.HttpContext.Items[StopwatchKey] as Stopwatch;
            if (loggingWatch != null)
                loggingWatch.Stop();
