...
{
    public class AccountpaybleRepository : RepositoryBase, IAccountpaybleRepository
    {

        public AccountpaybleRepository(IDbTransaction transaction) : base(transaction) { }
...
";
        ...
        public IEnumerable<TB_M_ACCOUNT_PAYABLEDto> All()
        {
            string sqlQuery = @"SELECT * FROM TB_M_ACCOUNT_PAYABLE;";
            var query = Connection.Query<TB_M_ACCOUNT_PAYABLEDto>(
                sql: sqlQuery
                , transaction: Transaction
                ).ToList();
        ...
        TB_M_ACCOUNT_PAYABLEDto IRepositories<TB_M_ACCOUNT_PAYABLEDto>.GetById(int id)
        {
            throw new System.NotImplementedException();
        }

        public void Insert(TB_M_ACCOUNT_PAYABLEDto entity)
        {
            throw new System.NotImplementedException();
        }

        public void Update(TB_M_ACCOUNT_PAYABLEDto entity)
        {
            throw new System.NotImplementedException();
        }
    }
