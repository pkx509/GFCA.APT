...
, (SELECT TOP 1 PROD_NAME FROM TB_M_PRODUCT WHERE PROD_CODE = A.PROD_CODE) 'PROD_NAME'
, (SELECT TOP 1 PROD_SKU FROM TB_M_PRODUCT WHERE PROD_CODE = A.PROD_CODE) 'PROD_SKU'
, (SELECT TOP 1 SIZE_CODE FROM TB_M_SIZE WHERE SIZE_CODE = A.PROD_SIZE) 'PROD_SIZE'
, (SELECT TOP 1 PACK_CODE FROM TB_M_PACK WHERE PACK_CODE = A.PROD_PACK) 'PROD_PACK'
, A.PROD_LTP_EXCL_VAT
, A.NORM_PERC_DISC
, A.NORM_PERC_GP
, A.NORM_SHELF_PRICE
